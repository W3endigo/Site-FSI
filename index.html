...
<html lang="fr">
  ...
  <header id="header">
   ...
   <div id="up_head" class="container_fluid">
       <center>
           <img id="logo" src="ressources/logo.png">
           <div  onclick="toggle_header()">
               <img id="user_image" src="ressources/deconnecte.png">
               <p id="username">Nom de l'utilisateur</p>
           </div>
        </center>       
    </div>

    <div id="connection_head" class="container_fluid">   
     <center>    
      <a id="a2" href="pages/html/connexion.php"><button id="button2" type="button" class="btn btn-primary btn-lg">Connexion</button></a>  
      <a id="a1" href="pages/html/inscription.php"><button id="button1"type="button" class="btn btn-primary btn-lg">Inscription</button></a>  
     </center>
    </div>
      
    </header>
  
  <body onscroll="toggle_icons()" onload="verif_connexion()">
    <div id="sticky_head" class="container_fluid sticky">
        <div id="apparait_index">    
            <a href="#up_head"><img src="ressources/maison.png" id="home"></a>         
      ...
      <div id="total" class="container-fluid">
        ...
        <div class="match">
          <div class="date">
            ...
            <div class="titre_match">
                <h1>
                Foot entre Fous
                </h1>
                <h3>Stade Jean Coquelin</h3>
          </div>
                <div class="nb_joueurs">
                    <img src="ressources/utilisateur.png">
                        <div>
